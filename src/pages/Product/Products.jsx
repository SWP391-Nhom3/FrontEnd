...
import { Card, Button, Image, Modal, Rate, Switch, Table, notification, Form, Input, InputNumber, Upload } from "antd";
...
const Products = () => {
    ...
    const handleUpdateProduct = async (values) => {
        ...
        try {
            await axios.put(`http://localhost:8080/api/products/${currentProduct.id}`, formData, {
                headers: {
                            ...
                            <>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Form.Item>
                                            <Button type="primary" htmlType="submit" style={{ backgroundColor: "#46B5C1" }}>
                                                Thêm
                                            </Button>
                                        </Form.Item>
                                    </Form>
