          ...
          >
            ...
            <Col span={18}>
              <Upload
                ...
                fileList={fileList} // Assuming fileList contains the initial image information
                showUploadList={{
                  showRemoveIcon: false, // Hide remove icon
                  showPreviewIcon: true, // Show preview icon (if you have a preview handler)
                }}
                beforeUpload={() => false} // Prevent uploading new files
              >
            ...
            <Col span={18}>
              {isLayoutReady && (
                <CKEditor
                  ...
                  config={{
                    ...editorConfig,
                    isReadOnly: true, // Make CKEditor read-only
                  }}
