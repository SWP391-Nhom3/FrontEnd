...
import { fetchBrands, fetchCategories, fetchUploadProduct } from '../../data/api'
...
const AddProduct = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            notification.error({
                message: "Đã xảy ra lỗi trong quá trình thêm sản phẩm. Vui lòng thử lại sau!",
                placement: "top",
            })
        }
    };
